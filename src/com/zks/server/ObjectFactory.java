 ...
 * generated in the com.zks.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.zks.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://server.zks.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zks.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.zks.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.zks.com/", name = "queryWeather")
